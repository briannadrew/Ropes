/* Name: Rope Data Structure (Assignment #2)
 * Author: Brianna Drew
 * Date Created: February 10th, 2020
 * Last Modified: March 8th, 2020
 * References: - https://www.geeksforgeeks.org/ropes-data-structure-fast-string-concatenation/
...
namespace Ropesv3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Ropes<char[]> R1 = new Ropes<char[]>();     // ropes
